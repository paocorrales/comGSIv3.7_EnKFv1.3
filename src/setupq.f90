...
! Declare local variables  
  ...
  real(r_kind) psges,sfcchk,ddiff,errorx,zsges
...
!    Scale errors by guess saturation q
     ...
     call tintrp31(qg,qsges,dlat,dlon,dpres,dtime,hrdifsig,&
          mype,nfldsig)
!     write(*,*)'obs:',i
!     write(*,*)'obs=',data(iqob,i)
!     write(*,*)'qsges=',qsges
!     write(*,*)'lat=',data(ilate,i)
!     write(*,*)'lon=',data(ilone,i)
!     write(*,*)'id=',data(id,i)
...
!    Check to see if observations is above the top of the model (regional mode)
     ...
     !write(*,*)'If dpres>rsig ratio_errors=',ratio_errors
     !write(*,*)'error=',error,' y rsig=',rsig
