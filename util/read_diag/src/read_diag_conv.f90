...
100  continue
     ...
     if (ii > 0) then
          ...
          do i=1,ii
             ...
             rprs=rdiagbuf(5,i)      ! observation pressure (hPa) !!!!!!!!!!!!!CHANGED TO ELEVATION
             ...
             rerr=1/rdiagbuf(16,i)   !  final observation error (diag file keep the inverse error)
             robs1=rdiagbuf(17,i)    !  observation
             rdpt1=rdiagbuf(18,i)    !  obs-ges used in analysis 
             robs2=rdiagbuf(20,i)    !  observation (if variable is uv)
             rdpt2=rdiagbuf(21,i)    !  obs-ges used in analysis
...
!
             ...
             write (42,'(A3," @ ",A8," : ",I3,F10.2,F8.2,F8.2,E12.3,I5,I5,5E12.3)') &
                   var,stationID,itype,rdhr,rlat,rlon,rprs,iuse,iusev,robs1,ddiff,robs2,rdpt2,rerr
